...
*/
function createNode( type, user_value, user_string, cql, offset, children ) {
	var n = new NODE();
	n.type = type;
	...
	*/
	...
	output("DEBUG:cN(): " + n.type + ":" + n.value + ": " + n.children.length);
...
function createLeafNode ( type, user_value, user_string, cql, offset) {
	var n = new NODE();
	n.type = type;
	n.userval = user_value;
	n.userx= user_string;
...
switch( act )
{
	...
	case 1:
	{
		 rval= createNode("cqlQuery", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 2:
	{
		 rval= createNode("searchClause", "", vstack[ vstack.length - 3 ]['userx'] + vstack[ vstack.length - 2 ]['userx'] + vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 3 ]['cql'] + vstack[ vstack.length - 2 ]['cql'] + vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 3 ], vstack[ vstack.length - 2 ], vstack[ vstack.length - 1 ]); 
	}
	break;
	case 3:
	{
		 rval= createNode("searchClause", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 4:
	{
		 rval= createNode("index", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 5:
	{
		 rval= createNode("searchTerm", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 6:
	{
		 rval= createNode("relation", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 7:
	{
		 rval= createNode("comparitor", vstack[ vstack.length - 1 ], vstack[ vstack.length - 1 ], vstack[ vstack.length - 1 ], offset(info)); 
	}
	break;
	case 8:
	{
		 rval= createNode("term", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]['children']); 
	}
	break;
	case 9:
	{
		 rval= createNode("identifier", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]['children']); 
	}
	break;
	case 10:
	{
	...
	case 11:
	{
		 rval= createNode("charString", "", vstack[ vstack.length - 1 ]['userx'], vstack[ vstack.length - 1 ]['cql'], offset(info), vstack[ vstack.length - 1 ]); 
	}
	break;
	case 12:
	{
		 rval= createNode("charString", "", vstack[ vstack.length - 3 ] + vstack[ vstack.length - 2 ]['userx'] + vstack[ vstack.length - 1 ],  '"' + vstack[ vstack.length - 2 ]['cql'] + '"', offset(info)); 
	}
	break;
	case 13:
	{
		 rval= createNode("alphanum", vstack[ vstack.length - 1 ], vstack[ vstack.length - 1 ], vstack[ vstack.length - 1 ], offset(info)); 
	}
	break;
	case 14:
	{
